...
return [
    ...
    */
    ...
    'custom' => [
        'establishment_id' => [
            'required_without' => 'El campo :attribute es obligatorio cuando no ha seleccionado "Otro establecimiento"',
        ],
        'establishment_name' => [
            'required_with' => 'Este campo es obligatorio cuando ha seleccionado "Otro establecimiento"',
        ],
        'is_current' => [
            'boolean' => 'El campo ":attribute" debe ser SI o NO.',
        ],
        'work_shift' => [
            'required_if' => 'El campo ":attribute" es obligatorio cuando el la actividad es actual',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        /* TeacherActivityRequest */
        'is_current'            => 'Es actual',
        'establishment_id'      => 'Establecimiento',
        'no_establishment'      => 'Otro Establecimiento',
        'establishment_name'    => 'Otro establecimiento',
        'educational_level_id'  => 'Nivel de Enseñanza',
        'subject'               => 'Espacio Curricular',
        'position_id'           => 'Cargo',
        'job_situation_id'      => 'Situación de revista',
        'hours'                 => 'Horas',
        'work_shift'            => 'Horario/Turno',
        /* WorkActivityRequest */
        // 'is_current'
        // 'description'
        'from'                  => 'Desde',
